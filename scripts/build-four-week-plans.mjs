...
const cohorts = {
  ...
  high1_current: [
    ...
    d('微粒数—物质的量双向换算', ['H1_MOLE_INTRO'],18), d('质量—摩尔质量—物质的量', ['H1_MOLE_INTRO'],18), d('先判断对象再使用N_A', ['H1_MOLE_INTRO'],18), d('摩尔质量易错单位', ['H1_MOLE_INTRO'],16), d('周期律与分类交叉辨析', ['H1_PERIODIC','H1_CLASSIFY'],20), d('四条已学主线错因回收', ['H1_MOLE_INTRO','H1_PERIODIC','H1_CLASSIFY','H1_ELECTROLYTE_INTRO'],22), d('第三周稳定性小测', ['H1_MOLE_INTRO','H1_PERIODIC'],22,'CLASS_QUIZ'),
