...
declare v_ids uuid[]; v_item jsonb; v_rows jsonb='[]'; v_warnings jsonb='[]'; v_student record; v_topic record; v_q record;
 v_date date; v_keep uuid[]; v_count integer; v_selected text[]; v_used text[]; v_all_used text[]; v_reason text; v_grade text;
