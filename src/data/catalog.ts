...
export const SKILLS: SkillDefinition[] = [
  ...
  { id: 'H1_GAS_MOLAR_VOLUME', title: '气体摩尔体积基础', moduleId: 'H1-F05B', gradeBand: '高一', maxLevel: 4, examImportance: 5, examDepth: 3, prerequisites: ['H1_MOLE_INTRO'], levelCriteria: criteria('检查气体与标准状况', '完成V与n一步换算', '连接V、n、N和m', '比较同温同压气体体积') },
...
export const KNOWLEDGE_CARDS: KnowledgeCard[] = [
  { id: 'KC-CLASSIFY', skillId: 'H1-CLASSIFY', title: '物质到底分成哪些？从总树干一路分到底', core: '物质先分为纯净物和混合物；纯净物再分为单质和化合物；氧化物、酸、碱、盐都挂在化合物下面。', detail: '每次都从“物质”出发，不跳级。确认纵向路径后，再用元数、强弱、溶解性、是否含氧等独立标准添加横向标签。', steps: ['先判断纯净物或混合物', '纯净物再判断单质或化合物', '化合物再判断氧化物、酸、碱或盐', '最后按题目要求补充横向标签'], commonMistakes: ['把盐酸和所有溶液当成纯净物', '把O₂与O₃的混合物当成单质', '把强弱与溶解性混为一谈'], microExample: 'H₂SO₄的路径是纯净物→化合物→无机化合物→酸；同时是二元酸、强酸、含氧酸和电解质。', asset: { type: 'diagram', alt: '物质分类树' }, reviewStatus: 'approved' },
  ...
  { id: 'KC-ELECTROLYTE', skillId: 'H1-ELECTROLYTE', title: '判断的是化合物本身', core: '电解质是在水溶液中或熔融状态下能导电的化合物。', detail: '金属单质能导电但不是化合物；蔗糖溶于水仍以分子为主，蔗糖是非电解质；SO₂与水反应形成的体系会产生离子，但SO₂物质本身不电离，仍判为非电解质。', steps: ['先确认是否为化合物', '看熔融或溶于水是否产生自由离子', '不要把溶液整体当研究对象'], commonMistakes: ['把铜判成电解质', '水溶液导电就把溶质判电解质'], microExample: '熔融NaCl含可移动离子，NaCl是电解质。', asset: { type: 'diagram', alt: '电解质微观导电示意' }, reviewStatus: 'approved' },
  ...
  { id: 'KC-REDOX', skillId: 'H1-REDOX-ROLE', title: '先看元素，再说身份', core: '升价→失电子→被氧化→发生氧化反应；反应物是还原剂，生成氧化产物。降价一侧完全对应相反。', detail: '降价→得电子→被还原→发生还原反应；反应物是氧化剂，生成还原产物。过程、反应物身份和生成物身份必须说完整。', steps: ['标发生变化元素的化合价', '写升降与电子得失', '写被氧化/被还原及发生的反应', '确认氧化剂/还原剂与对应产物'], commonMistakes: ['把氧化剂说成发生氧化反应', '漏写发生氧化反应或发生还原反应', '只看是否含氧'], microExample: 'Zn + Cu²⁺ = Zn²⁺ + Cu中，Zn升价、失电子、被氧化并发生氧化反应；Zn是还原剂，Zn²⁺是氧化产物。', asset: { type: 'diagram', alt: '氧化还原完整身份对应图' }, reviewStatus: 'approved' },
  { id: 'KC-MOLE', skillId: 'H1-MOLE', title: '先认目标微粒', core: 'n = N/N_A；化学式下标决定目标微粒的倍数。', detail: '题目对象可能是分子、原子、离子、电子、质子、中子或离子晶体的化学式单位。先完整写出“1 mol这种物质含几mol目标微粒”，再换算。', steps: ['圈出完整的目标微粒名称', '写1 mol物质对应的微粒倍数', '再用n与N换算'], commonMistakes: ['忘记化学式下标', '把原子数当分子数', '把NaCl化学式单位说成NaCl分子'], microExample: '1 mol ²³Na原子含11 mol质子、12 mol中子和11 mol电子；1 mol NaCl晶体表示1 mol NaCl化学式单位。', asset: { type: 'diagram', alt: '物质的量关系网络' }, reviewStatus: 'approved' },
...
export const QUESTIONS: Question[] = [
  ...
  q('Q-H1-R-01','M-H1-R-A','H1-REDOX-ROLE',1,'高一','反应Zn+Cu²⁺=Zn²⁺+Cu中，Zn的作用是', ['氧化剂','还原剂','氧化产物','还原产物'],1,'Zn由0价升到+2价，失电子、被氧化并发生氧化反应；Zn是还原剂，Zn²⁺是氧化产物。'),
  q('Q-H1-R-02','M-H1-R-B','H1-REDOX-ROLE',2,'高一','氧化剂在反应中', ['失电子，被氧化','得电子，被还原','失电子，被还原','得电子，被氧化'],1,'氧化剂得到电子、被还原，自身发生还原反应，并生成还原产物。'),
