...
describe('phone registration', () => {
  it('requires a teacher-issued invite before collecting a guardian and child phone', async () => {
    ...
    expect(screen.getByRole('img', { name: '甘老师企业微信二维码，扫码添加好友' })).toBeInTheDocument()
    expect(screen.getByRole('link', { name: '查看企业微信名片大图' })).toHaveAttribute('href', '/gan-chemistry-august-review/wechat-add.jpg')
